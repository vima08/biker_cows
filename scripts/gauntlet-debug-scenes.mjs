...
try{
 ...
 for(const [name,route] of Object.entries({title:'?art=vector',select:'?scene=select&art=vector',stage1:'?scene=game&hero=cassia&art=vector',stage1Boss:'?scene=boss&hero=bruna&art=vector',stage2:'?scene=brawler&hero=nova&art=vector',stage2Boss:'?scene=brawler-boss&hero=bruna&art=vector',roadRash:'?scene=road-rash&hero=cassia&art=vector',roadRashBoss:'?scene=road-rash-boss&hero=cassia&art=vector'})){
